  ...
  describe("instance", () => {
    ...
    describe("methods", () => {
      ...
      describe("addFoldingHandler(title, content, funct)", () => {
        ...
        test("does not throw", () => {
          expect(
            instance.addFoldingHandler(title, content, funct)
          ).not.toThrow();
        });
      });
      ...
      describe("storePaletteElements(id, titleElement)", () => {
        ...
        test("does not throw", () => {
          expect(instance.storePaletteElements(id, titleElement)).not.toThrow();
        });
      });
      ...
      describe("appendTitleToContainer(title)", () => {
        ...
        test("does not throw", () => {
          expect(instance.appendTitleToContainer(title)).not.toThrow();
        });
      });
    });
  });
